    ...
    <main className='font-medium text-gray-200'>
      ...
      <div className='py-12 md:py-24 bg-polar-100 shadow-inner'>
        <div className='grid max-w-screen-xl px-6 mx-auto lg:px-8 xl:px-4 md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20'>
          <div className='self-center order-2 col-span-2 mt-12 md:order-1 md:mt-0'>
            <h1 className=' text-3xl font-bold text-white md:text-4xl lg:text-5xl md:mb-4 lg:mb-8'>Kythi.</h1>
            ...
            <div className='flex mb-6 space-x-4'>
              <button className='inline-block px-5 py-2 font-semibold text-white rounded-lg focus:outline-none bg-frost-400 hover:bg-frost-300'>Login</button>
              <button className='px-5 py-2 font-semibold text-white rounded-lg focus:outline-none bg-aurora-red-200 hover:bg-aurora-red-100 inline-flex items-center'>
                Sign Up
              </button>
            </div>
      ...
      <div className='bg-polar-300 pt-20 shadow-inner'>
        <div className='max-w-screen-xl px-6 pb-12 mx-auto lg:px-8 xl:px-4 lg:pb-16 xl:pb-24'>
          ...
          <div className='grid items-stretch md:grid-cols-3 content-center place-items-center gap-8'>
            <div className='p-6 bg-polar-100 hover:bg-polar-400 lg:duration-700 ease-in-out w-full border-none rounded-md md:p-8 lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
            ...
            <div className='p-6 bg-polar-100 border-none w-full hover:bg-polar-400 lg:duration-700 ease-in-out rounded-md md:p-8 lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
              <div className='flex items-baseline justify-between mb-4'>
            ...
            <div className='p-6 bg-polar-100 hover:bg-polar-400 border-none rounded-md w-full md:p-8 lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
              <div className='flex items-baseline justify-between mb-4'>
                <h4 className='text-xl font-bold lg:text-2xl'>Latest technologies</h4>
                <svg xmlns='http://www.w3.org/2000/svg' className='h-6 w-6' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z' />
                </svg>
              </div>
              <p className='mb-6 text-lg text-gray-200'>We use the latest web technologies, providing blazing fast load times, up-time and quick deployment.</p>
            </div>
            <div className='p-6 bg-polar-100 hover:bg-polar-400 lg:duration-700 border-none w-full rounded-md md:p-8 lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
              <div className='flex items-baseline justify-between mb-4'>
              ...
              <p className='mb-6 text-lg text-gray-200'>You can view our code on <a className='text-frost-300' href='https://github.com/KythiX'>GitHub</a>. This ensures you know what happens with your data and how it happens.</p>
            </div>
            <div className='p-6 bg-polar-100 hover:bg-polar-400 lg:duration-700 border-none rounded-md w-full md:p-8 lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
              <div className='flex items-baseline justify-between mb-4'>
              ...
              <p className='mb-6 text-lg text-gray-200'>You can add your own domain, free of charge.</p>
            </div>

            <div className='p-6 bg-polar-100 hover:bg-polar-400 lg:duration-700 border-none rounded-lg md:p-8 w-full lg:py-12 md:shadow-lg md:hover:shadow-lg md:transition-all md:duration-500 h-56'>
              <div className='flex items-baseline justify-between mb-4'>
              ...
              <p className='mb-6 text-lg text-gray-200'>We provide almost fast support and answers, with a member of staff almost always being available.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='grid max-w-screen-xl gap-6 px-6 mx-auto lg:px-8 xl:px-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-8'>
          ...
          <div>
            ...
            <nav className='mt-4'>
              <ul className='space-y-2'>
                <li>
                  <a href='https://kythi.com' className='text-base hover:text-gray-300'>Kythi Bio's</a>
                </li>
                <li>
