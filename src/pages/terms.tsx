    ...
    <>
      <Center>
        <Code mt="50px" w="80%" px="30px" py="30px" borderRadius="10px">
          ...
          <UnorderedList mt="15px">
            <ListItem>If a user is found to be under the age of 13, we will delete their account at upon finding out as well as reporting their account(s) to discord if they have any.</ListItem>
            <ListItem>You will NOT not share your account with anyone and doing so will result in an account deletion effective immediately</ListItem>
            <ListItem>Upon mass uploading content and/or mass shortening URLs in attempt to DoS the service your account will be wiped along with your file(s)</ListItem>
            <ListItem>If you attempt to DDoS/DoS our service(s) we will delete your account this will be effective immediately</ListItem>
          </UnorderedList>
        </Code>
      </Center>
    </>
