    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center h-screen p-4">
        <div className="bg-polar-200 rounded-md p-6 lg:w-3/12">
          <h1 className="text-4xl font-bold text-snow-300">
            Testimonial Submission
          </h1>
          <h2 className="mt-3 font-semibold text-snow-100">
            Thank you for using our service! We are delighted that you want to
            submit a Review/Testimonial Please fill out the form below add it to
            our site and we will get back to you as soon as possible!
          </h2>
          <textarea
          ...
          <button
            onClick={() => {
              sendToast("Successfully Submitted Testimonial!", "success");
            }}
