          ...
          <div className="text-center bg-polar-200 rounded-md lg:px-6 md:px-6 px-3 py-4 text-white">
            ...
            <div className="flex justify-between lg:flex-row md:flex-row flex-col md:space-x-8 lg:space-x-8">
              ...
              <button
                ...
                className="normal-case md:w-36 w-full lg:w-36 h-8 border-0 lg:mt-6 md:mt-6 mt-2 btn-sm font-medium text-sm rounded-md bg-aurora-red-200 hover:bg-aurora-red-400"
              >
                Delete Account
              </button>
            </div>
            <button
              ...
              className="text-sm w-full mt-6 border-0 btn-sm h-10 font-medium rounded-md bg-[#239d56] hover:bg-[#1f8b4d] shadow-lg"
            >
              Save Changes
            </button>
          </div>
